...
The broadside reference does not reveal the true stock thickness, hidden backside construction, exact alloy composition, or unseen wear. Those regions are explicitly recorded as inferred in the model runtime provenance.
